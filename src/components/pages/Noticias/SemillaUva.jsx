...
const NewsPage = ({ location }) => {
                    ...
                    <div className='news-page-header-apli-carac-img-container'>
                        <div className='news-page-header-apli-carac-container'>
                            <div className='news-page-header-apli-container'>
                                ...
                                <p>
                                En Vinumar somos especialistas en la elaboración de extracto de semilla de uva (también conocido como OPC). La experiencia, unida a la fuerte inversión en equipamientos de alto rendimiento, nos permiten ofrecer una gran flexibilidad, pudiendo adaptar nuestras producciones de extractos de semilla de uva a las necesidades del cliente. 
    ...
    return (
        <>
            <Head pageTitle='Semilla de uva - Vinumar' description='En Vinumar somos especialistas en semilla de uva para diversas aplicaciones. Más de 60 años de experiencia. Contacta con nosotros.' />
