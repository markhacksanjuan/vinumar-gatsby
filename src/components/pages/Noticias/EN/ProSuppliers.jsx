...
const Enocyanin = ({ location }) => {
    ...
    return (
        <>
            <Head pageTitle='Proanthocyanidins suppliers - Vinumar' description='At Vinumar we are proanthocyanidins suppliers with more than 60 years of experience. Experts in proanthocyanidins. Contact us.' />
