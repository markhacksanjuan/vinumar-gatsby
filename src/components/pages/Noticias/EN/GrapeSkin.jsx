...
const Enocyanin = ({ location }) => {
            ...
            <>
                <div className='news-page-header'>
                    <div className='news-page-header-title'>
                        <h1 className='news-page-h1'>What are grape skin extracts?</h1>
                        <p><b>Grape skin extracts, also known as enocyanin, is a 100% natural colouring, coming from the skin of the red grapes <i>Vitis Vinifera</i>. </b>
                        ...
                        <span className="parrafo">The presence of anthocyanins highlights the power of grape skin extracts as these substances are well known for their multiple healthy properties. Therefore, the user of enocyanin is not only getting a natural coulouring but also an important added value.</span>
                    ...
                    <div className='news-page-header-apli-carac-img-container'>
                        <div className='news-page-header-apli-carac-container'>
                            <div className='news-page-header-apli-container'>
                                <h2 className='news-page-h2'>At Vinumar, we are specialist on grape skin extracts.</h2>
                                <p><b>At Vinumar we are specialists in the production of grape skin extracts or enocyanin.</b> Our experience, together with our strong investment in high performance equipment, allows us to offer great flexibility, being able to adapt our production of grape skin extracts to our customers' needs.
                            ...
                            <div className='news-page-header-carac-container'>
                                <h2 className='news-page-h2'>What are the applications of grape skin extracts?</h2>
    ...
    return (
        <>
            <Head pageTitle='Grape skin extracts - Vinumar' description='At Vinumar we are grape skin extracts suppliers with more than 60 years of experience. Experts in grape skin extracts. Contact us.' />
