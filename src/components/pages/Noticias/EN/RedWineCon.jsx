...
const Enocyanin = ({ location }) => {
            ...
            <>
                <div className='news-page-header'>
                    <div className='news-page-header-title'>
                        <h1 className='news-page-h1'>What is red wine concentrate?</h1>
                        <p><b>Red wine concentrate is a natural substance obtained from the concentration of red wines previously selected and conveniently dealcoholised. </b>
                    ...
                    <div className='news-page-header-apli-carac-img-container'>
                        <div className='news-page-header-apli-carac-container'>
                            <div className='news-page-header-apli-container'>
                                <h2 className='news-page-h2'>At Vinumar, we are specialist on red wine concentrate.</h2>
                                <p><b>At Vinumar we are specialist on the manufacture of red wine concentrate.</b> The experience together with the big investment in high performance equipment provide us a great flexibility, being able to adapt our wine extract productions to the different needs of our customers. 
                            ...
                            <div className='news-page-header-carac-container'>
                                <h2 className='news-page-h2'>What are the applications of red wine concentrate?</h2>
                                <p><b>Red wine concentrate can be used in different applications, but it is in the food and beverage industry where its use is most widespread.</b> Wine extracts are widely used as culinary bases in the preparation of sauces, marinades, or ready meals. It is also used in the formulation of beverages.
    ...
    return (
        <>
            <Head pageTitle='Red Wine Concentrate - Vinumar' description='At Vinumar we are red wine concentrate suppliers with more than 60 years of experience. Experts in red wine concentrate. Contact us.' />
