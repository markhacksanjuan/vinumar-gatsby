...
import semillaImg from '../../../../images/NEWS/Imagen 15.jpg'
...
const Enocyanin = ({ location }) => {
            ...
            <>
                <div className='news-page-header'>
                    <div className='news-page-header-title'>
                        <h1 className='news-page-h1'>What is wine concentrate?</h1>
                        <p><b>Wine concentrate is a natural substance obtained from the concentration of red and white wines previously selected and conveniently dealcoholised. </b>
                    ...
                    <div className='news-page-header-apli-carac-img-container'>
                        <div className='news-page-header-apli-carac-container'>
                            <div className='news-page-header-apli-container'>
                                <h2 className='news-page-h2'>At Vinumar, we are specialist on wine concentrate.</h2>
                                <p><b>At Vinumar we are specialist on the manufacture of wine concentrate.</b> The experience together with the big investment in high performance equipment provide us a great flexibility, being able to adapt our wine extracts productions to the different needs of our customers. 
                            ...
                            <div className='news-page-header-carac-container'>
                                <h2 className='news-page-h2'>What are the applications of wine concentrate?</h2>
                                <p>Wine concentrate can be used in different applications, but it is in the food and beverage industry where its use is most widespread.<b> Wine extracts are widely used as culinary bases in the preparation of sauces, marinades, or ready meals.</b> They are also used in the formulation of beverages.
    ...
    return (
        <>
            <Head pageTitle='Wine Concentrate - Vinumar' description='At Vinumar we are wine concentrate suppliers with more than 60 years of experience. Experts in wine concentrate. Contact us.' />
