                    ...
                    <div className='news-page-header-apli-carac-img-container'>
                        <div className='news-page-header-apli-carac-container'>
                            <div className='news-page-header-apli-container'>
                                ...
                                <p><b>Grape seed extract is a phenolic compound found in the seeds of white grapes <i>(Vitis Vinifera)</i>.</b> Oligomeric proanthocyanidins (also known by the acronym OPC), are one of the main compounds found in grape seed extract, and they are one of the most powerful natural antioxidants in existence.
