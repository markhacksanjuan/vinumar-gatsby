...
const Enocyanin = ({ location }) => {
                    ...
                    <div className='news-page-header-apli-carac-img-container'>
                        <div className='news-page-header-apli-carac-container'>
                            <div className='news-page-header-apli-container'>
                                <h2 className='news-page-h2'>At Vinumar, we are specialist on red wine extract.</h2>
                                <p><b>At Vinumar we are specialist on the manufacture of red wine extract.</b> The experience together with the big investment in high performance equipment provide us a great flexibility, being able to adapt our wine concentrate productions to the different needs of our customers. 
    ...
    return (
        <>
            <Head pageTitle='Red Wine Extracts - Vinumar' description='At Vinumar we are red wine extracts suppliers with more than 60 years of experience. Experts in red wine extracts. Contact us.' />
