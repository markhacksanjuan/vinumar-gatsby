                    ...
                    <div className='news-page-header-apli-carac-img-container'>
                        <div className='news-page-header-apli-carac-container'>
                            <div className='news-page-header-apli-container'>
                                ...
                                <span className="parrafo">Grape polyphenols from <i>Vitis Vinifera</i> are one of the most powerful natural antioxidants in existence. Due to their effectiveness in combating the molecules responsible for damaging human metabolism (the so-called free radicals), these phenolic compounds are increasingly in demand in different industries as they offer a significant added value for their consumers, whether in human or animal nutrition.</span>
                                </p>
                            </div>
