                ...
                <div className='news-page-header'>
                    <div className='news-page-header-title'>
                        ...
                        <p>
                            ...
                            <span className="parrafo">Los polifenoles de uva procedentes de la Vitis Vinifera están considerados como uno de los antioxidantes naturales más potentes que existen. Gracias a su eficacia para combatir las moléculas encargadas de dañar el metabolismo humano (los llamados radicales libres), estos compuestos fenólicos son cada vez más demandados en las diferentes industrias con el fin de ofrecer polifenoles con un importante valor añadido para sus consumidores, ya sean en nutrición humana o en nutrición animal.  </span>
                        </p>
                    </div>
