...
import semillaImg from '../../../images/NEWS/Imagen 2.jpg'
...
const NewsPage = ({ location }) => {
            ...
            <>
                <div className='news-page-header'>
                    <div className='news-page-header-title'>
                        <h1 className='news-page-h1'>¿Qué es el extracto de uva?</h1>
                        <p><b>Los extractos de semillas de uva son compuestos fenólicos que se encuentran en las semillas de las uvas blancas <i>(Vitis Vinifera)</i>.</b> Las procianidinas oligoméricas (también conocidas con las siglas OPC), son uno de los principales compuestos que se encuentran en los extractos de semillas de uva, y están considerados como uno de los antioxidantes naturales más potentes que existen. 
                    ...
                    <div className='news-page-header-apli-carac-img-container'>
                        <div className='news-page-header-apli-carac-container'>
                            <div className='news-page-header-apli-container'>
                                <h2 className='news-page-h2'>En Vinumar somos especialistas en extracto de uva</h2>
                                <p><b>En Vinumar somos especialistas en la elaboración de extracto de semilla de uva (también conocido como OPC).</b> La experiencia, unida a la fuerte inversión en equipamientos de alto rendimiento, nos permiten ofrecer una gran flexibilidad, pudiendo adaptar nuestras producciones de extractos de semilla de uva a las necesidades del cliente.
                            ...
                            <div className='news-page-header-carac-container'>
                                <h2 className='news-page-h2'>¿Cuáles son las aplicaciones del extracto de uva?</h2>
                                <p>La eficacia de los polifenoles en los extractos de semilla de uva ha sido demostrada en diversos estudios científicos, teniendo un alto poder antioxidante. Por esta razón, la principal aplicación del extracto de semilla de uva se encuentra en la industria alimentaria y nutracéutica, con la elaboración de alimentos y bebidas funcionales y suplementos alimenticios.
    ...
    return (
        <>
            <Head pageTitle='Extracto de uva - Vinumar' description='En Vinumar somos especialistas en extracto de uva para diversas aplicaciones. Más de 60 años de experiencia. Contacta con nosotros.' />
