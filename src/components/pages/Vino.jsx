...
const ExtractosVino = ({ location, lang }) => {
    ...
    return(
        <>
        <Head keywordsPage={key_wine} pageTitle={langText.head.wine[lang]} description='VINUWINE - Extracto de vino, concentrado de vino - wine extracts, wine concentrate'/>
            <Layout pageLocation={location}>
                ...
                <Button style='red-button' width='270' goTo={lang === 'es' ? '/contacto' : '/en/contact-us'}>{langText.wine.button[lang]}</Button>
