...
const IndexPage = ({}) => {
      ...
      <>
        <div id='productos' className={`index-container-product ${scroll > 800 && 'index-container-product-animated'}`}>
          ...
          <div className='index-container-cards'>
            <div className={`index-card ${scroll > 1000 && 'index-card-animated-bottom'}`}>
              <ProductoCard 
            ...
            <div className={`index-card ${scroll > 1200 && 'index-card-animated-bottom'}`}>
              <ProductoCard 
            ...
            <div className={`index-card ${scroll > 1400 && 'index-card-animated-bottom'}`}>
              <ProductoCard 
            ...
            <div className={`index-card ${scroll > 1600 && 'index-card-animated-bottom'}`}>
              <ProductoCard 
                title='Alcoholes'
            ...
            <div className={`index-card ${scroll > 1800 && 'index-card-animated-bottom'}`}>
              <ProductoCard 
                title='Pepita de uva'
  ...
  const renderDonde = () => {
    return(
      <>
        <div className={`index-container-donde ${scroll > 2400 && 'donde-animated'}`}>
          <h2>Dónde estamos</h2>
          <div className={`index-card-donde `}>
            <div className={`index-container-donde-text `}>
              <p className={`index-donde-direccion ${scroll > 2400 && 'index-donde-direccion-animated'}`}>ctra. Munera, 5
                <span>02600 Villarrobledo</span>
                <span>Albacete, España</span>
              </p>
              <div className={`index-donde-text ${scroll > 2400 && 'index-donde-text-animated'}`}>
              ...
              <img className={`index-donde-img ${scroll > 2400 && 'index-donde-img-animated'}`} src={dondeImg} alt='Donde estamos' />
          </div>
        </div>
      </>
    )
  ...
  return (
    <main>
      ...
      <div className='index-container'>
        {renderHeader()}
        <div className={`text-centered-bottom ${scroll > 80  && 'text-centered-animated-bottom'}`}>
        ...
        {renderProductos()}
        {renderDonde()}
        <div className={`text-centered-bottom ${scroll > 3400 && 'text-centered-animated-bottom'}`}>
          <TextCentered width='960px' margin='60px'>Más de 60 años haciendo historia en el mundo de la uva.</TextCentered>
        </div>
      </div>
        <div className={`index-button-mas ${scroll > 3650 && 'index-button-mas-animated'}`}>
