      ...
      <>
        <div className='index-container-header'>
          ...
          <div className="index-container-header-h2">
            <h2 className="index-h2">{langText_index.head_title[lang.lang]}</h2>
          </div>
          ...
          <div className="button-fade-in">
            <Button style='white-button' goTo='#productos'>{langText_index.button_view_products[lang.lang]}</Button>
          </div>
    ...
    return(
      <>
        <div id='productos' className={`index-container-product ${scrollProductos && 'index-container-product-animated'}`}>
          <h2>{langText_index.products.title[lang.lang]}</h2>
          <div className='index-container-cards'>
            <div className={`index-card ${scrollPiel && 'index-card-animated-bottom'}`}>
              <ProductoCard 
                title={langText_index.products.grape_skin.title[lang.lang]}
                text={langText_index.products.grape_skin.text[lang.lang]}
                image={extPiel}
            ...
            <div className={`index-card ${scrollVino && 'index-card-animated-bottom'}`}>
              <ProductoCard 
                title={langText_index.products.wine_extracts.title[lang.lang]}
                text={langText_index.products.wine_extracts.text[lang.lang]}
                image={extVino}
            ...
            <div className={`index-card ${scrollTaninos && 'index-card-animated-bottom'}`}>
              <ProductoCard 
                title={langText_index.products.grape_tannins.title[lang.lang]}
                text={langText_index.products.grape_tannins.text[lang.lang]}
                image={taninosUva}
            ...
            <div className={`index-card ${scrollAlcoholes && 'index-card-animated-bottom'}`}>
              <ProductoCard 
                title={langText_index.products.alcohols.title[lang.lang]}
                text={langText_index.products.alcohols.text[lang.lang]}
                image={alcohol}
            ...
            <div className={`index-card ${scrollPepita && 'index-card-animated-bottom'}`}>
              <ProductoCard 
                title={langText_index.products.grape_seed.title[lang.lang]}
                text={langText_index.products.grape_seed.text[lang.lang]}
                image={pepitas}
    ...
    return(
      <>
        <div className={`index-container-donde ${scrollDonde && 'donde-animated'}`}>
          <h2>{langText_index.where.title[lang.lang]}</h2>
          <div className={`index-card-donde `}>
            <div className={`index-container-donde-text `}>
              ...
              <div className={`index-donde-text ${scrollDonde && 'index-donde-text-animated'}`}>
                <p>{langText_index.where.text_top[lang.lang]}
                <span className="parrafo">{langText_index.where.text_bottom[lang.lang]}</span>
                </p>
              </div>
            </div>
      ...
      <Layout>
        <div className='index-container'>
          ...
          <div className={`text-centered-bottom ${scrollTextCentered_1  && 'text-centered-animated-bottom'}`}>
            <TextCentered>{langText_index.text_centered_top[lang.lang]}</TextCentered>
          </div>
          {renderProductos()}
          {renderDonde()}
          <div className={`text-centered-fade-in ${scrollTextCentered_2 && 'fade-in'}`}>
            <TextCentered width='960px' margin='60px'>{langText_index.text_centered_bottom[lang.lang]}</TextCentered>
          </div>
        </div>
          <div className={`index-button-mas ${scrollButton && 'fade-in'}`}>
            <Button text='SABER MÁS SOBRE VINUMAR' goTo='/nosotros/Valores' style='red-button' width='292px'>{langText_index.button_know_more[lang.lang]}</Button>
          </div>
      </Layout>
    </>
  )
